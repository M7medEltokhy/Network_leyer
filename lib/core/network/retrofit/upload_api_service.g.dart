...
class _UploadApiService implements UploadApiService {
  ...
  Future<BaseResponse<UploadFileResponse>> uploadImages(
    ...
    final _options = _setStreamType<BaseResponse<UploadFileResponse>>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    late BaseResponse<UploadFileResponse> _value;
    try {
      _value = BaseResponse<UploadFileResponse>.fromJson(
        _result.data!,
        (json) => UploadFileResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
